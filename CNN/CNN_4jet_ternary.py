...
#dim_image = [[int(75/10), int(75/10)], [[-5, 5], [-np.pi, np.pi]]]
best_model_dir = '/home/samhuang/ML/best_model/'
save_model_name = best_model_dir+'best_model_ternary_CNN_4jetloc_kappa0.15-13/'
signal=[r'$W^+/W^+$',r'$W^-/W^-$',r'$Z/Z$', r'$W^+/W^-$', r'$W^+/Z$', r'$W^-/Z$']

# Input datasets
sample_folder = '/home/samhuang/ML/sample/event_base/'
data_folder = sample_folder+"samples_kappa0.15_4jetloc-13/VBF_H5pp_ww_jjjj_and_VBF_H5mm_ww_jjjj_and_VBF_H5z_zz_jjjj_and_VBF_H5z_ww_jjjj_and_VBF_H5p_wz_jjjj_and_VBF_H5m_wz_jjjj/"
