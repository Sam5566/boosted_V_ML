...
def parse_image(data_record, dim_image, N_labels):
    ...
    sequence_features = {
        ...
        'E' : tf.io.FixedLenSequenceFeature([dim_image[0][0]], tf.float32),
    }
    ...
    E = tf.ensure_shape(tf.convert_to_tensor(sequence_data['E']), list(dim_image[0]))
...
def parse_flatten(data_record, dim_image, N_labels):
    ...
    sequence_features = {
        ...
        'Ej' : tf.io.FixedLenSequenceFeature([dim_image[0][0]], tf.float32),
    }
