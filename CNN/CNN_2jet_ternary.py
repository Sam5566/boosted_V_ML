...
save_model_name = best_model_dir+'best_model_ternary_CNN_2jet_kappa0.15/'
signal=[r'$W^+/W^+$',r'$W^-/W^-$',r'$Z/Z$', r'$W^+/W^-$', r'$W^+/Z$$', r'$W^-/Z$']

# Input datasets
sample_folder = '/home/samhuang/ML/sample/event_base/'
data_folder = sample_folder+"samples_kappa0.15_2jet/VBF_H5pp_ww_jjjj_and_VBF_H5mm_ww_jjjj_and_VBF_H5z_zz_jjjj_and_VBF_H5z_ww_jjjj_and_VBF_H5p_wz_jjjj_and_VBF_H5m_wz_jjjj/"
...
for i_try in range(Ntry):
    ...
    #for dd in dataset_tr:
    	...
    	#break
    # Create the model  
    model = models.CNN_2jet(dim_image=dim_image[0] + [4], n_class=6)
    #print(model.summary())
