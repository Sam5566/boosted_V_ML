...
save_model_name = best_model_dir+'best_model_ternary_CNNsq_kappa0.15_2jet/'

# Input datasets
sample_folder = '/home/samhuang/ML/sample/'
#data_folder = "sample/samples_kappa0.15/samples_kappa0.15/"
data_folder = sample_folder+"samples_kappa0.15_2jet/VBF_H5pp_ww_jjjj_and_VBF_H5mm_ww_jjjj_and_VBF_H5z_zz_jjjj/"
...
# Create the model  
model = models.CNNsq_2jet(dim_image=dim_image[0] + [4], n_class=3)
#print(model.summary())
