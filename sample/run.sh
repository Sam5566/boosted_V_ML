...
python extract.py $kappa_value /home/samhuang/ML/sample/VBF_H5pp_ww_jjjj/Events/test/tag_1_delphes_events.root &> extract.log1 &
python extract.py $kappa_value /home/samhuang/ML/sample/VBF_H5mm_ww_jjjj/Events/test/tag_1_delphes_events.root &> extract.log2 &
python extract.py $kappa_value /home/samhuang/ML/sample/VBF_H5z_zz_jjjj/Events/test/tag_1_delphes_events.root &> extract.log3 &
