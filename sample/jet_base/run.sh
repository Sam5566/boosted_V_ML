kappa_value=0.3 #// this value need to be modified in main() of File extract.py
...
python extract$extra.py $kappa_value /home/samhuang/ML/sample/VBF_H5pp_ww_jjjj/Events/run_02/tag_1_delphes_events.root /home/samhuang/ML/sample/VBF_H5pp_ww_jjjj/Events/run_03/tag_1_delphes_events.root /home/samhuang/ML/sample/VBF_H5pp_ww_jjjj/Events/run_05/tag_1_delphes_events.root &> extract.log1 &
python extract$extra.py $kappa_value /home/samhuang/ML/sample/VBF_H5mm_ww_jjjj/Events/run_02/tag_1_delphes_events.root /home/samhuang/ML/sample/VBF_H5mm_ww_jjjj/Events/run_03/tag_1_delphes_events.root /home/samhuang/ML/sample/VBF_H5mm_ww_jjjj/Events/run_04/tag_1_delphes_events.root &> extract.log2 &
python extract$extra.py $kappa_value /home/samhuang/ML/sample/VBF_H5z_zz_jjjj/Events/run_02/tag_1_delphes_events.root /home/samhuang/ML/sample/VBF_H5z_zz_jjjj/Events/run_03/tag_1_delphes_events.root &> extract.log3 &
...
#python extract.py $kappa_value /home/samhuang/ML/sample/VBF_H5pp_ww_jjjj/Events/test2/tag_1_delphes_events.root &> extract.log1 &
#python extract.py $kappa_value /home/samhuang/ML/sample/VBF_H5mm_ww_jjjj/Events/test2/tag_1_delphes_events.root &> extract.log2 &
#python extract.py $kappa_value /home/samhuang/ML/sample/VBF_H5z_zz_jjjj/Events/test2/tag_1_delphes_events.root &> extract.log3 &
wait
...
python convert$extra.py samples_kappa$kappa_value$extra/VBF_H5pp_ww_jjjj.npy samples_kappa$kappa_value$extra/VBF_H5mm_ww_jjjj.npy samples_kappa$kappa_value$extra/VBF_H5z_zz_jjjj.npy &> convert.log1 &
python convert2_WmZ.py samples_kappa$kappa_value$extra/VBF_H5mm_ww_jjjj.npy samples_kappa$kappa_value$extra/VBF_H5z_zz_jjjj.npy &> convert.log2 &
python convert2_WpZ.py samples_kappa$kappa_value$extra/VBF_H5pp_ww_jjjj.npy samples_kappa$kappa_value$extra/VBF_H5z_zz_jjjj.npy &> convert.log3 &
python convert2_WpWm.py samples_kappa$kappa_value$extra/VBF_H5pp_ww_jjjj.npy samples_kappa$kappa_value$extra/VBF_H5mm_ww_jjjj.npy &> convert.log4 &
